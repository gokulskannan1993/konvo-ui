                    ...
                    <div className="w-full">
                        <form onSubmit={handleLogin}>
                            <div className="space-y-4">
                                ...
                                <p className="text-sm ">Sign in to your account to continue your language journey</p>
                            ...
                            <div className="form-control w-full mb-4">
                                ...
                                <input type="email" placeholder="Enter your email" className="input input-bordered w-full" required value={loginData.email} onChange={(e) => setLoginData({ ...loginData, email: e.target.value })} />
                            </div>
                            ...
                            <div className="form-control w-full mb-4">
                                ...
                                <input type="password" placeholder="Enter your password" className="input input-bordered w-full" required value={loginData.password} onChange={(e) => setLoginData({ ...loginData, password: e.target.value })} />
                            </div>

                            <div className="form-control w-full mb-4">
                                <label className="label cursor-pointer justify-start gap-2">
                                    <span className="label-text">Forgot Password?</span>
                                    <Link to="/login" className="text-primary">Reset Password</Link>
                                </label>
                            </div>
                ...
                <div className="hidden lg:flex lg:w-1/2 w-full bg-primary/10 p-4 sm:p-8 items-center justify-center">
                    <div className="max-w-md p-8">
                        <div className="relative aspect-square max-w-sm mx-auto">
                            <img src="../public/i.png" alt="Sign Up" className="w-full h-full" />
                        </div>
