...
import { getLanguageFlag, capitalizeFirstLetter, formatLocation } from '../lib/utils.js'
            ...
            <div className='container mx-auto space-y-10'>
                ...
                <section>
                    <div className='mb-6 sm:mb-8'>
                        <div className='flex flex-col sm:flex-row items-start justify-between sm:items-center gap-4'>
                            <div>
                                <h2 className='text-2xl sm:text-3xl font-bold tracking-tight'>Recommended Users</h2>
                    ...
                    {loadingRecommendedUsers ?
                        ...
                        recommendedUsers.length === 0 ?
                            (<div className='card bg-base-200 p-6 text-center'>
                                <h3 className='font-semibold text-lg mb-2'>No recommended users available</h3>
                            ...
                            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                                {recommendedUsers.map((user) => {
                                    ...
                                    return (
                                        ...
                                        <div key={user._id} className="card bg-base-200 hover:shadow-md transition-shadow p-4">
                                            <div className="card-body p-4">
                                                ...
                                                <div className='flex flex-wrap gap-1.5 mb-3'>
                                                    <span className='badge badge-secondary  p-4'>
                                                        <img src={getLanguageFlag(user?.nativeLanguage)} alt={user?.nativeLanguage} className="inline-block h-3 mr-1" />
                                                        Native: {capitalizeFirstLetter(user?.nativeLanguage)}
                                                    </span>
                                                    <span className='badge badge-outline p-4'>
                                                        <img src={getLanguageFlag(user?.learningLanguage)} alt={user?.learningLanguage} className="inline-block h-3 mr-1" />
